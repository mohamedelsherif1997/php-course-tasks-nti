                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="teal fas fa-medkit"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Drugs</p>
                                                <span class="number"><?php echo (mysqli_num_rows($op1)); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                                        <hr />
                                        <div class="stats">
                                            <i class="fas fa-calendar"></i> Total numbers of drugs
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number"><?php echo (mysqli_num_rows($op)); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                                        <hr />
                                        <div class="stats">
                                            <i class="fas fa-calendar"></i> Total users
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Roles</p>
                                                <a href="#"><span class="number"><?php echo(mysqli_num_rows($op2)); ?></span></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="footer">
                                        <hr />
                                        <div class="stats">
                                            <i class="fas fa-envelope-open-text"></i> Available roles
                                        </div>
                                    </div>
                                </div>
                            </div>
